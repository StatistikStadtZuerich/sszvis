  ...
  .prop("bounds", {
    palm() {
      ...
      return {
        ...
        left: 10,
        height: 20 + 6 * panelHeight + 5 * PANEL_PADDING + bottomPadding,
      };
    },
    lap() {
      ...
      return {
        ...
        bottom: bottomPadding,
        left: 20,
        height: 20 + 4 * panelHeight + 3 * PANEL_PADDING + bottomPadding,
      };
    },
    _() {
      ...
      return {
        ...
        bottom: bottomPadding,
        left: 20,
        height: 20 + 3 * panelHeight + 2 * PANEL_PADDING + bottomPadding,
      };
    },
  });
...
function render(state) {
  ...
  const yScale = d3.scaleLinear().domain([0, state.maxY]).range([100, 0]); // Will be scaled per panel
  ...
  panels.selectAll(".sszvis-multiple").each(function (d) {
    ...
    // Category label
    panelSelection
      .selectAll(".sszvis-multiple-category-label")
      .data([d.category])
      .join("text")
      .classed("sszvis-multiple-category-label", true)
      .attr("x", 0)
      .attr("y", -10)
