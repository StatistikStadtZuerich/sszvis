...
export declare function createHtmlLayer<G extends BaseType = BaseType, D = unknown, P extends BaseType = BaseType, PD = unknown>(selector: SelectableElement<G, D, P, PD> | HTMLElement, bounds?: BoundsResult, metadata?: LayerMetadata): LayerSelection<HTMLDivElement, number>;
