 ...
 */
export declare const halfPixel: (pos: number) => number;
/**
 ...
 */
export declare const roundTransformString: (transformStr: string) => string;
/**
 ...
 */
export declare const transformTranslateSubpixelShift: (transformStr: string) => [number, number];
