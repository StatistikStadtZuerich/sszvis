/*! sszvis v2.0.1, Copyright 2014-present Statistik Stadt Zürich */
    ...
    .render(function () {
      ...
      if (defined(props.tickLength)) {
        ...
        var ticks = tickGroups.filter(function (d) {
          return (
            !stringEqual(d, domainExtent[0]) &&
            !stringEqual(d, domainExtent[1])
          );
        });
        ...
        if (props.hideLabelThreshold > 0 && !props.slant) {
          ...
          activeBounds.forEach(function (active) {
            passiveBounds.forEach(function (passive) {
              d3.select(passive.node).classed(
                "hidden",
      ...
      if (props.contour && props.slant) {
        ...
        tickGroups.each(function () {
          ...
          if (textContour.empty()) {
            textContour = d3.select(textNode.cloneNode()).classed(
...
var withAlpha = function (c, a) {
  ...
  return (
    "rgba(" + rgbColor.r + "," + rgbColor.g + "," + rgbColor.b + "," + a + ")"
  );
};
 ...
 * @property {boolean} removeStroke        A boolean that removes the default stroke applied to the text
...
var rangeRuler = function () {
  return component()
    ...
    .render(function (data) {
      ...
      var line$$1 = selection$$1.selectAll(".sszvis-rangeRuler__rule").data([0]);
      ...
      var marks = selection$$1.selectAll(".sszvis-rangeRuler--mark").data(data);
...
var line$2 = function() {
  ...
  return component()
    ...
    .render(function(data) {
      ...
      var line$$1 = d3.line()
        .defined(compose(not(isNaN), props.y))
        .x(props.x)
        .y(props.y);
...
var pie = function () {
  return component()
    ...
    .render(function (data) {
      ...
      selection$$1.datum(data).call(ta);
    });
};
...
var stackedArea = function () {
  return component()
    ...
    .render(function (data) {
      ...
      var areaGen = d3.area().x(props.x).y0(props.y0).y1(props.y1);

      var paths = selection$$1.selectAll("path.sszvis-path").data(data, props.key);
  ...
  return function (_stackAcc, seriesAcc, valueAcc) {
    return function (data) {
      ...
      stacks.maxValue = d3.max(stacks, function (stack$$1) {
        return d3.max(stack$$1, function (d) {
          return d[1];
        });
      });
...
function stackedBar(config) {
  return component()
    ...
    .render(function (data) {
      ...
      var groups = selection$$1.selectAll(".sszvis-stack").data(data);
