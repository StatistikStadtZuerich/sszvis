  ...
  (function () {
    ...
    var serializeXML = function (node, output) {
      ...
      if (nodeType == 3) {
        ...
        output.push(
          node.textContent.replace(/&/, "&amp;").replace(/</, "&lt;").replace(">", "&gt;")
        );
      } else if (nodeType == 1) {
        // ELEMENT nodes.
...
----------------------------------------------- */
  ...
  var slantLabel = {
    top: {
      horizontal: function (selection$$1) {
        selection$$1.style("text-anchor", "middle").attr("dx", "-0.5").attr("transform", null);
      },
  ...
  function bounds(arg1 /* bounds or selection */, arg2 /* [selection] */) {
    ...
    var dimensions = defined(selection$$1)
      ? measureDimensions(selection$$1)
      : { width: DEFAULT_WIDTH };
...
----------------------------------------------- */
  ...
  function createSvgLayer(selector, bounds$$1, metadata) {
    ...
    svgEnter.append("desc").text(description);
  ...
  var fallbackRender = function (selector, options) {
    ...
    selection$$1.append("img").attr("class", "sszvis-fallback-image").attr("src", options.src);
  };
  ...
  var move = function () {
    ...
    var moveComponent = component()
      ...
      .render(function () {
        ...
        var layer = selection$$1.selectAll("[data-sszvis-behavior-move]").data([0]);
  ...
  var voronoi$1 = function () {
    ...
    var voronoiComponent = component()
      ...
      .render(function (data) {
        ...
        var voronoi$$1 = d3.voronoi().x(props.x).y(props.y).extent(props.bounds);

        var polys = selection$$1
        ...
        polys
          ...
          .on("touchstart", function (datum) {
            var cbox = this.parentNode.getBoundingClientRect();
            if (
              eventNearPoint(firstTouch(d3.event), [
                cbox.left + props.x(datum.data),
                cbox.top + props.y(datum.data),
              ])
            ) {
  ...
  var smallMultiples = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var multiples = selection$$1.selectAll("g.sszvis-multiple").data(data);
  ...
  var prepareData$1 = function () {
    ...
    function main(data) {
      ...
      var root = d3
        .hierarchy({ isSunburstRoot: true, values: nester.entries(data) }, prop("values"))
        .sort(sortFn)
        .sum(function (x) {
      ...
      return flatten$$1(root).filter(function (d) {
...
----------------------------------------------- */
  ...
  function ensureDefsSelection(selection$$1) {
    var defs = selection$$1.selectAll("defs").data([0]);
  ...
  var handleRuler = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var group = selection$$1.selectAll(".sszvis-handleRuler__group").data([0]);
        ...
        var labelOutline = selection$$1.selectAll(".sszvis-ruler__label-outline").data(data);
        ...
        var label = selection$$1.selectAll(".sszvis-ruler__label").data(data);
  ...
  var slider = function () {
    return component()
      ...
      .render(function () {
        ...
        var alteredScale = props.scale
          .copy()
          .range([scaleRange[0] + handleSideOffset, scaleRange[1] - handleSideOffset]);

        // the mostly unchanging bits
        var bg = selection$$1.selectAll("g.sszvis-control-slider__backgroundgroup").data([1]);
        ...
        var newAxisSelection = axisSelection
          .enter()
          .append("g")
        ...
        var newBackgroundSelection = backgroundSelection
          .enter()
          .append("g")
        ...
        var shadow = backgroundSelection
        ...
        var handle = selection$$1.selectAll("g.sszvis-control-slider__handle").data([props.value]);
        handle.exit().remove();

        var handleEntering = handle
          .enter()
          .append("g")
  ...
  var mapLakeGradientMask = function (selection$$1) {
    selection$$1.attr("maskContentUnits", "objectBoundingBox");
  ...
  var circle = function () {
    return component()
      ...
      .render(function (data) {
        ...
        ensureDefsElement(selection$$1, "pattern", "data-area-pattern").call(dataAreaPattern);

        var dataArea = selection$$1.selectAll(".sszvis-dataareacircle").data(data);
        ...
        if (props.caption) {
          var dataCaptions = selection$$1.selectAll(".sszvis-dataareacircle__caption").data(data);
  ...
  var line$1 = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var line$$1 = selection$$1.selectAll(".sszvis-referenceline").data(data);

        line$$1.exit().remove();

        var newLine = line$$1.enter().append("line").classed("sszvis-referenceline", true);

        line$$1 = line$$1.merge(newLine);

        line$$1.attr("x1", x1).attr("y1", y1).attr("x2", x2).attr("y2", y2);

        if (props.caption) {
          var caption = selection$$1.selectAll(".sszvis-referenceline__caption").data([0]);
  ...
  var tooltipAnchor = function () {
    return component()
      .prop("position")
      .position(functor([0, 0]))
      .prop("debug")
      .render(function (data) {
        var selection$$1 = d3.select(this);
        var props = selection$$1.props();

        var anchor = selection$$1.selectAll("[data-tooltip-anchor]").data(data);
        ...
        if (props.debug) {
          var referencePoint = selection$$1.selectAll("[data-tooltip-anchor-debug]").data(data);
  ...
  var rangeRuler = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var newLine = line$$1.enter().append("line").classed("sszvis-rangeRuler__rule", true);
        ...
        var total = selection$$1.selectAll(".sszvis-rangeRuler__total").data([last(data)]);
  ...
  var rectangle = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var dataArea = selection$$1.selectAll(".sszvis-dataarearectangle").data(data);
  ...
  var ruler = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var ruler = selection$$1.selectAll(".sszvis-ruler__rule").data(data, labelId);
        ...
        var dot = selection$$1.selectAll(".sszvis-ruler__dot").data(data, labelId);
        ...
        var label = selection$$1.selectAll(".sszvis-ruler__label").data(data, labelId);
...
----------------------------------------------- */
  ...
  var tooltipRenderer = function () {
    return component()
      .prop("header")
      .prop("body")
      .prop("orientation", functor)
      .orientation("bottom")
      .prop("dx", functor)
      .dx(1)
      .prop("dy", functor)
      .dy(1)
      .prop("opacity", functor)
      .opacity(1)
      .renderSelection(function (selection$$1) {
        ...
        var isDef = defined;
        var isSmall =
          (isDef(props.header) && !isDef(props.body)) ||
          (!isDef(props.header) && isDef(props.body));

        // Select tooltip elements

        var tooltip = selection$$1.selectAll(".sszvis-tooltip").data(tooltipData);
  ...
  var bar = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var bars = selection$$1.selectAll(".sszvis-bar").data(data);
  ...
  var dot = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var dots = selection$$1.selectAll(".sszvis-circle").data(data);
  ...
  var groupedBars = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var groups = selection$$1.selectAll("g.sszvis-bargroup").data(data);
  ...
  var line$2 = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var path = selection$$1.selectAll(".sszvis-line").data(data, props.key);
  ...
  var pyramid = function () {
    return component()
      ...
      .render(function (data) {
        ...
        selection$$1.selectGroup("left").datum(props.leftAccessor(data)).call(leftBar);

        selection$$1.selectGroup("right").datum(props.rightAccessor(data)).call(rightBar);
  ...
  function lineComponent() {
    return component()
      ...
      .render(function (data) {
        ...
        var line$$1 = selection$$1.selectAll(".sszvis-pyramid__referenceline").data(data);

        line$$1.exit().remove();

        var newLine = line$$1.enter().append("path").attr("class", "sszvis-pyramid__referenceline");
  ...
  var sankey = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var barGroup = selection$$1.selectGroup("nodes").datum(data.nodes);
...
----------------------------------------------- */
  function stackedPyramid() {
    return component()
      ...
      .render(function (data) {
        ...
        selection$$1.selectGroup("leftStack").datum(props.leftAccessor(data)).call(leftStack);

        selection$$1.selectGroup("rightStack").datum(props.rightAccessor(data)).call(rightStack);
  ...
  function stackComponent() {
    return component()
      ...
      .renderSelection(function (selection$$1) {
        ...
        var stack$$1 = selection$$1.selectAll("[data-sszvis-stack]").data(datum);

        var newStack = stack$$1.enter().append("g").attr("data-sszvis-stack", "");
  ...
  function lineComponent$1() {
    return component()
      ...
      .render(function (data) {
        ...
        var line$$1 = selection$$1.selectAll(".sszvis-path").data(data);
  ...
  var sunburst = function () {
    return component()
      .prop("angleScale")
      .angleScale(d3.scaleLinear().range([0, 2 * Math.PI]))
      .prop("radiusScale")
      .prop("centerRadius")
      .prop("fill")
      .prop("stroke")
    ...
    return component()
      ...
      .render(function () {
        ...
        if (!props.displayValues)
          return error("legend.binnedColorScale - display values must be specified.");
        ...
        var circles = selection$$1.selectAll("circle.sszvis-legend__circle").data(props.endpoints);
        ...
        var segments = selection$$1.selectAll("rect.sszvis-legend__crispmark").data(rectData);
        ...
        var lines = selection$$1.selectAll("line.sszvis-legend__crispmark").data(lineData);
        ...
        var labels = selection$$1.selectAll(".sszvis-legend__axislabel").data(lineData);
  ...
  var linearColorScale = function () {
    return component()
      ...
      .render(function () {
        ...
        var segments = selection$$1.selectAll("rect.sszvis-legend__mark").data(values);
        ...
        var endCaps = selection$$1.selectAll("circle.ssvis-legend--mark").data(startEnd);
        ...
        var labels = selection$$1.selectAll(".sszvis-legend__label").data(labelText);
  ...
  var ordinalColorScale = function () {
    return component()
      ...
      .render(function () {
        ...
        var groups = selection$$1.selectAll(".sszvis-legend--entry").data(domain);
    ...
    return component()
      ...
      .render(function () {
        ...
        var tickValues = props.tickValues || [
          domain[1],
          props.scale.invert(d3.mean(props.scale.range())),
          domain[0],
        ];
        var maxRadius = range$1(props.scale)[1];

        var group = selection$$1.selectAll("g.sszvis-legend__elementgroup").data([0]);
...
----------------------------------------------- */
  ...
  function isBounds(arg1) {
    return (
      defined(arg1) &&
      defined(arg1.width) &&
      defined(arg1.screenWidth) &&
      defined(arg1.screenHeight)
    );
  }
  ...
  function validatePropSpec(propSpec, breakpointSpec) {
    ...
    for (var breakpointName in propSpec) {
      if (propSpec.hasOwnProperty(breakpointName)) {
        if (
          breakpointName !== "_" &&
          !defined(breakpointFindByName(breakpointSpec, breakpointName))
        ) {
          return false;
        }
      }
   ...
   */
  var swissMapProjection = memoize(
  ...
  var bubble = function () {
    ...
    var anchoredCirclesComponent = component()
      ...
      .prop("radius", functor)
      .prop("fill", functor)
      .prop("strokeColor", functor)
      .strokeColor("#ffffff")
      .prop("strokeWidth", functor)
      .strokeWidth(1)
      .prop("transition")
      .transition(true)
      .render(function () {
        ...
        var anchoredCircles = selection$$1
  ...
  var mapRendererBase = function () {
    return component()
      ...
      .render(function () {
        ...
        ensureDefsElement(selection$$1, "pattern", "missing-pattern").call(mapMissingValuePattern);
        ...
        var mapAreas = selection$$1.selectAll(".sszvis-map__area").data(props.mergedData);
        ...
        selection$$1.selectAll(".sszvis-map__area--undefined").attr("fill", getMapFill);
        ...
        var tooltipGroup = selection$$1.selectGroup("tooltipAnchors").datum(props.mergedData);
  ...
  var geojson = function () {
    ...
    var geojsonComponent = component()
      ...
      .render(function (data) {
        ...
        var geoElements = selection$$1.selectAll(".sszvis-map__geojsonelement").data(mergedData);
        ...
        selection$$1.selectAll(".sszvis-map__geojsonelement--undefined").attr("fill", getMapFill);
        ...
        var tooltipGroup = selection$$1.selectGroup("tooltipAnchors").datum(mergedData);
  ...
  var mapRendererHighlight = function () {
    return component()
      ...
      .prop("highlightStroke", functor)
      .highlightStroke("white") // a function for highlighted entity stroke colors (default: white)
      .prop("highlightStrokeWidth", functor)
      .highlightStrokeWidth(2)
      .render(function () {
        var selection$$1 = d3.select(this);
        var props = selection$$1.props();

        var highlightBorders = selection$$1.selectAll(".sszvis-map__highlight");
  ...
  var image = function () {
    return component()
      ...
      .render(function () {
        ...
        var image = selection$$1.selectAll(".sszvis-map__image").data([0]); // At the moment, 1 image per container
  ...
  var mapRendererMesh = function () {
    return component()
      ...
      .render(function () {
        ...
        var meshLine = selection$$1.selectAll(".sszvis-map__border").data([props.geoJson]);
  ...
  var mapRendererPatternedLakeOverlay = function () {
    return component()
      ...
      .render(function () {
        ...
        // the lake texture
        ensureDefsElement(selection$$1, "pattern", "lake-pattern").call(mapLakePattern);

        if (props.fadeOut) {
          // the fade gradient
          ensureDefsElement(selection$$1, "linearGradient", "lake-fade-gradient").call(
            mapLakeFadeGradient
          );

          // the mask, which uses the fade gradient
          ensureDefsElement(selection$$1, "mask", "lake-fade-mask").call(mapLakeGradientMask);
        }

        // generate the Lake Zurich path
        var zurichSee = selection$$1.selectAll(".sszvis-map__lakezurich").data([props.lakeFeature]);
        ...
        var lakePath = selection$$1.selectAll(".sszvis-map__lakepath").data([props.lakeBounds]);
  ...
  var raster = function () {
    return component()
      ...
      .render(function (data) {
        ...
        var canvas = selection$$1.selectAll(".sszvis-map__rasterimage").data([0]);
