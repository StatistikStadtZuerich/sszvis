...
describe("stackedAreaMultiplesLayout", () => {
  describe("band geometry", () => {
    ...
    test("should draw gapless multiples when the padding ratio is 0", () => {
    ...
    test("should leave no room for the bands when the padding ratio is 1", () => {
  ...
  describe("baseline range", () => {
    test("should count downwards from the top, starting at the bottom of the first band", () => {
    ...
    test("should sit the last baseline on the bottom of the chart", () => {
      const { range } = layoutStackedAreaMultiples(300, 3);
      expect(range.at(-1)).toBeCloseTo(300, 9);
    });

    test("should space consecutive baselines one step apart", () => {
    ...
    test("should fill the whole height when there is a single stack", () => {
  ...
  describe("baseline count", () => {
    test("should return exactly one baseline per stack at any height", () => {
