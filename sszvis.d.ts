import { BaseType, Selection, NumberValue, HierarchyNode, AxisScale, AxisDomain, ScaleContinuousNumeric, ScaleTime, ScaleBand, ScalePoint, ScaleOrdinal, LabColor, ScaleLinear, HSLColor, SeriesPoint, HierarchyCircularNode, ValueFn, HierarchyRectangularNode, FormatLocaleDefinition, TimeLocaleDefinition, ExtendedFeature, ExtendedFeatureCollection, ExtendedGeometryCollection, GeoGeometryObjects, GeoProjection, GeoPath, GeoPermissibleObjects } from 'd3';
...
declare function export_default$e<T = unknown>(): ConfidenceBarComponent<T>;
...
declare function export_default$d<T = unknown>(defaultVal: TooltipOrientation, bounds: Bounds): (d: TooltipData$1<T>) => TooltipOrientation;
...
declare function export_default$c<T = unknown>(): LineComponent$1<T>;
...
declare function export_default$b<T = unknown>(): RangeFlagComponent<T>;
...
declare function export_default$a<T = unknown>(): RangeRulerComponent<T>;
...
declare function export_default$9<T = unknown>(): RectangleComponent<T>;
...
declare function export_default$8<T = unknown>(): TooltipComponent<T>;
 ...
 */
type ColorAccessor$2<T> = (datum?: T, index?: number) => string | null | undefined;
/**
...
interface BarComponent<T = unknown> extends ComponentBuilder<BarComponent<T>> {
    ...
    fill(): ColorAccessor$2<T> | undefined;
    fill<U = T>(value: BarValue<U, string | undefined>): BarComponent<T>;
    stroke(): ColorAccessor$2<T> | undefined;
...
declare function bar<T = unknown>(): BarComponent<T>;
...
type ColorValue$1<T> = DotValue<T, string | null | undefined>;
interface DotComponent<T = unknown> extends ComponentBuilder<DotComponent<T>> {
    x(): StoredAccessor$2<T, number> | undefined;
    x<U = T>(value: DotValue<U, number>): DotComponent<T>;
    y(): StoredAccessor$2<T, number> | undefined;
    y<U = T>(value: DotValue<U, number>): DotComponent<T>;
    radius(): StoredAccessor$2<T, number> | undefined;
    radius<U = T>(value: DotValue<U, number>): DotComponent<T>;
    stroke(): StoredAccessor$2<T, string | null | undefined> | undefined;
    stroke<U = T>(value: ColorValue$1<U>): DotComponent<T>;
    fill(): StoredAccessor$2<T, string | null | undefined> | undefined;
    fill<U = T>(value: ColorValue$1<U>): DotComponent<T>;
    transition(): boolean;
    transition(enabled: boolean): DotComponent<T>;
}
declare function dot<T = unknown>(): DotComponent<T>;
...
interface LineComponent<P = unknown, L = unknown> extends ComponentBuilder<LineComponent<P, L>> {
    ...
    y<Q = P>(value: number | PointAccessor$2<Q, number>): LineComponent<P, L>;
...
declare function line<P = unknown, L = unknown>(): LineComponent<P, L>;
 ...
 */
type StackedBarSlice<T, X extends string | number = string> = SeriesPoint<T | undefined> & {
 ...
 * @template T The type of the original flat data objects
 */
declare function pack<T = unknown>(): PackComponent<T>;
...
type AngleAccessor<T = unknown> = (d: T) => number;
/**
 ...
 * getters return.
 */
type ColorAccessor$1<T = unknown> = (d: T, i: number) => string | null | undefined;
type ColorValue<T = unknown> = string | null | undefined | ColorAccessor$1<T>;
/**
 ...
 */
interface PieComponent<T = unknown> extends ComponentBuilder<PieComponent<T>> {
...
declare function pie<T = unknown>(): PieComponent<T>;
...
declare function pyramid<T = unknown, D = unknown>(): PyramidComponent<T, D>;
...
declare function export_default$4(): SankeyComponent;
 ...
 * directly.
 */
declare function stackedArea<P = unknown, L extends Iterable<P> = P[]>(): StackedAreaComponent<P, L>;
 ...
 * directly.
 */
declare function stackedAreaMultiples<P = unknown, L = P[]>(): StackedAreaMultiplesComponent<P, L>;
 ...
 */
type StackedPyramidSlice<T, S extends string | number = string> = SeriesPoint<T | undefined> & {
    /** The series key the slice belongs to. */
    series: string;
 ...
 */
interface StackedPyramidReferencePoint {
 ...
 * @template T The type of the original flat data objects
 */
declare function treemap<T = unknown>(): TreemapComponent<T>;
...
declare function export_default$2<G extends SmallMultipleGroup = SmallMultipleGroup>(): SmallMultiplesComponent<G>;
...
declare function export_default$1(): BinnedColorScaleComponent;
...
declare function legendColorLinear(): LinearColorScaleComponent;
...
declare function swissMapProjection(width: number, height: number, featureCollection: MapGeoObject, featureBoundsCacheKey?: string): GeoProjection;
declare namespace swissMapProjection {
...
declare function mapRendererBase<T = unknown>(): MapRendererBaseComponent<T>;
...
declare function mapRendererBubble<T = unknown>(): MapRendererBubbleComponent<T>;
 ...
 */
type ChoroplethEventHandler<T = object> = (datum: T | undefined) => void;
/**
...
declare function choropleth<T extends object = object>(): ChoroplethComponent<T>;
