 ...
 */
export type StackedPyramidSidesData<T, S extends string | number = string> = StackedPyramidSide<T, S>[] & {
    /**
 ...
 */
export declare function stackedPyramidLayout<T, S extends string | number = string>(sideAcc: (datum: T) => S, rowValueAcc: (datum: T) => string | number, seriesAcc: (datum: T) => string | number, valueAcc: (datum: T) => number): (data: T[]) => StackedPyramidLayout<T, S>;
/**
 ...
 */
export declare function stackedPyramidData<T, S extends string | number = string>(sideAcc: (datum: T) => S, rowValueAcc: (datum: T) => string | number, seriesAcc: (datum: T) => string | number, valueAcc: (datum: T) => number): (data: T[]) => StackedPyramidSidesData<T, S>;
/**
