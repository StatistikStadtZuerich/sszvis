...
rowValueAcc, seriesAcc, valueAcc) {
  return data => {
    ...
    const maxValue = (_max = max(sides, s => max(s, rows => max(rows, row => row[1])))) !== null && _max !== void 0 ? _max : 0;
    return {
      sides,
      maxValue
    };
...
export { stackedPyramid, stackedPyramidData, stackedPyramidLayout };
//# sourceMappingURL=stackedPyramid.js.map
