...
An array of labels for the legend endpoints. If not supplied, defaults to using the first and last tick values. For string labels, name the type: `legendColorLinear<string>()`.
