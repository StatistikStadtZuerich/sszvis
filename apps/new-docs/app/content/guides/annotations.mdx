...
<Example
  ...
  data="line-chart/data/SL_daily.csv"
/>
...
<Example
  ...
  data="scatterplot/data/VRS_basic.csv"
/>
...
<Example
  ...
  data="scatterplot/data/SS_refline_fake.csv"
/>
...
<Example
  ...
  data="area-chart-stacked/data/SA_2Categories_yearly.csv"
/>
...
<Example
  ...
  data="line-chart/data/confidence.csv"
/>
...
<Example
  ...
  data="bar-chart-vertical-nested/data/nested.csv"
/>
