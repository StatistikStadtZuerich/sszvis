...
<Example id="line-chart/annotated" />
...
<Example id="scatterplot/refline-fake" />
...
<Example id="area-chart-stacked/sa-two" />
...
<Example id="line-chart/confidence" />
...
<Example id="bar-chart-vertical-nested/confidence" />
