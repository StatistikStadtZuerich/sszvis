...
<Example name="map-kreis" source="map-standard/kreis.html" data="map-standard/data/M_kreis.csv" />
...
<Example
  ...
  data="map-standard/data/M_wahlkreis_fake.csv"
/>
...
<Example
  ...
  data="map-standard/data/S_quartiere.csv"
/>
...
<Example
  ...
  data="map-standard/data/CML_quartier_years.csv"
/>
...
<Example
  ...
  data="map-standard/data/M_statzone_fake.csv"
/>
...
<Example
  ...
  data="map-standard/data/agglomeration_2012.csv"
/>
...
<Example
  ...
  data="map-standard/data/M_swiss_fake.csv"
/>
