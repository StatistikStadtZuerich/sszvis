...
<Example
  ...
  data="map-extended/data/gemeinnuetzige.csv"
/>

## Topografische Grundkarte der Stadt Zürich

<Example name="map-topographic" source="map-extended/topolayer-stadtkreise.html" />
...
<Example
  ...
  data="map-extended/data/kinder_segmented.csv"
/>
...
<Example
  ...
  data="map-extended/data/kinder.csv"
/>
...
<Example
  ...
  data="map-extended/data/kinder100.csv"
/>
...
<Example
  ...
  data="map-extended/data/kinder200.csv"
/>
