/**
 * Raster map of Zurich where each 200m cell is shaded by a binned colour scale.
 *
...
sszvis.app<State, Actions>({
  ...
  render(state) {
    ...
    const chartLayer = sszvis.createSvgLayer(config.id, bounds, {
      ...
      description: "Anzahl Kinder je Rasterzelle von 200 auf 200 Metern, in fünf Klassen.",
    });
