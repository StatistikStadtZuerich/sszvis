...
export declare const elementFromEvent: (evt: {
    clientX: number;
    clientY: number;
} | null) => Element | null;
export declare const datumFromPannableElement: <T = unknown>(element: Element | null) => DatumContainer<T> | null;
export declare const datumFromPanEvent: <T = unknown>(panEvent: Touch | null) => DatumContainer<T> | null;
export declare const testBarThreshold: <T>(cursorValue: number, datum: T, accessor: (d: T) => number, threshold: number) => boolean;
export {};
